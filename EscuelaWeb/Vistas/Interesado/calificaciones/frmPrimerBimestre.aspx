<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPrimerBimestre.aspx.cs" Inherits="EscuelaWeb.Vistas.Interesado.calificaciones.frmPrimerBimestre" %>
...
<form id="form1" runat="server">   
    ...
    <div class="contenedorMenu">
        ...
        <div class="ParteDerecha">
            <h1 style="background-color:blue; color:yellow; text-align:center;">PRIMER BIMESTRE</h1>
            <div class="tabla">
