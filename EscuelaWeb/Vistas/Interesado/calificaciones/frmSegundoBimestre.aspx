<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmSegundoBimestre.aspx.cs" Inherits="EscuelaWeb.Vistas.Interesado.calificaciones.frmSegundoBimestre" %>
...
<form id="form1" runat="server">   
    ...
    <div class="contenedorMenu">
        ...
        <div class="ParteDerecha">
            <h1 style="background-color:blue; color:yellow; text-align:center;">SEGUNDO BIMESTRE</h1>
            <div class="tabla">
