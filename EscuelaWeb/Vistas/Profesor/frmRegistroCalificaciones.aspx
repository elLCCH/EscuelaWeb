    ...
    <div class="contenedorMenu">
        ...
        <div class="ParteDerecha">
            <div class ="Calificaciones">      
                <div>
                <asp:DropDownList ID="ddlAnio" runat="server" CssClass="separacion" OnTextChanged="ddlAnio_TextChanged" AutoPostBack="True"></asp:DropDownList>
                    <br />
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <br />
                    <asp:GridView ID="GridViewMostrar" runat="server" DataSourceID="SqlDataSourceMaterias" OnSelectedIndexChanged="GridViewMostrar_SelectedIndexChanged">
                        <Columns>
                            <asp:CommandField ShowSelectButton="True" SelectText="CONFIRMAR SELECCION" >
